...
public class Plotly {
        ...
        static JsonObject getVariant(String chartName) {
                var inputStream = new InputStreamReader(PlotlyComponents.class
                                .getResourceAsStream(String.format("/variants/plotly.%s.props.json", chartName)));
                return JsonParser.parseReader(inputStream).getAsJsonObject();
        }
        ...
        public static ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
                        ...
                        .setSchema(SCHEMA)
                        .setEvents(Arrays.asList(ONCLICK_HANDLER, ONHOVER_HANDLER, ONUNHOVER_HANDLER,
                                        ONLEGENDCLICK_HANDLER,
                        ...
                        .addPaletteEntry("plotly-bar", "Plotly Bar", "A Plotly.js bar component", null,
                                        getVariant("bar"))
                        .addPaletteEntry("plotly-line", "Plotly Line", "A Plotly.js line component", null,
                                        getVariant("line"))
                        .addPaletteEntry("plotly-area", "Plotly Area", "A Plotly.js area component", null,
                                        getVariant("area"))
                        ...
                        .addPaletteEntry("plotly-heatmap", "Plotly Heatmap", "A Plotly.js heatmap component", null,
                                        getVariant("heatmap"))
                        .addPaletteEntry("plotly-radar", "Plotly Radar", "A Plotly.js radar component", null,
                                        getVariant("radar"))
                        .addPaletteEntry("plotly-waterfall", "Plotly Waterfall", "A Plotly.js waterfall component",
                                        null,
                                        getVariant("waterfall"))
                        .addPaletteEntry("plotly-gauge", "Plotly Gauge", "A Plotly.js gauge component", null,
                                        getVariant("gauge"))
                        .addPaletteEntry("plotly-3dsurface", "Plotly 3D Surface", "A Plotly.js 3D surface component",
                                        null,
                                        getVariant("3dsurface"))
                        .addPaletteEntry("plotly-scatter3d", "Plotly Scatter 3D", "A Plotly.js scatter 3D component",
                                        null,
                                        getVariant("scatter3d"))
                        .addPaletteEntry("plotly-streamtube", "Plotly Streamtube", "A Plotly.js streamtube component",
                                        null,
                                        getVariant("streamtube"))
                        .addPaletteEntry("plotly-isosurface", "Plotly Isosurface", "A Plotly.js isosurface component",
                                        null,
